...
for i in "${!POLICIES[@]}"; do
    ...
    DB=wandb://artifacts/navigation_sharing_db
...
python3 -m tools.analyze +eval_db_uri=wandb://artifacts/navigation_sharing_db run=run_nav_sharing ++analyze.output_path=s3://softmax-public/policydash/nav_sharing.html \
